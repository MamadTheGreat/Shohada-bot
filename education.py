...
def get_remove_keyboard():
    """حذف کیبورد برای امکان تایپ راحت‌تر"""
    return {
...
def handle_education(text):
    ...
    if "دیابت" in text or "قند" in text:
        ...
        return ("💓 *آموزش فشار خون:*\n"
                ...
                "- مصرف نمک را به شدت کاهش دهید (حداکثر ۱ قاشق چایخوری در روز)\n"
                "- مصرف پتاسیم (موز، سبزیجات) و کلسیم را افزایش دهید.\n"
                "- از استرس دوری کنید و خواب کافی داشته باشید.")
        ...
        return ("🫀 *سلامت قلب و عروق:*\n"
                ...
                "- در صورت احساس هرگونه درد یا سنگینی قفسه سینه، فورا به پزشک مراجعه کنید.")
